...
!$  IF(OMP_GET_THREAD_NUM().EQ.0) THEN
      ...
      WRITE(*,'(a18)') 'CAF Buffers Version'
!$    WRITE(*,'(a18)') 'OpenMP Version'
      WRITE(*,'(a14,i6)') 'Task Count ',parallel%max_task !CAF
!$    WRITE(*,'(a15,i5)') 'Thread Count: ',OMP_GET_NUM_THREADS()
      WRITE(*,*)
      WRITE(0,*)
      WRITE(0,'(a15,f8.3)') 'Clover Version ',g_version
      WRITE(0,'(a18)') 'CAF Buffers Version'
!$    WRITE(0,'(a18)') 'OpenMP Version'
      WRITE(0,'(a14,i6)') 'Task Count ',parallel%max_task !CAF
